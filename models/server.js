...
class Server {
    ...
    constructor() {
        ...
        this.paths = {
            ...
            client: '/api/client',
            uploads: '/api/uploads',
            provider: '/api/providers', // Ruta para la API de subida de archivos
            registeradmin : '/api/registeradmins',
    ...
    routes() {
        ...
        this.app.use(this.paths.registeradmin, require('../routes/register-admin'));  
    }
